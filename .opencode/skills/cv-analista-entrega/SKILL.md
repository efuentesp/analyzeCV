...
- Debe enfocarse en logros, contribuciones, responsabilidades clave y competencias relevantes al rol de Analista de entrega documental, no en el sujeto.
...
- Análisis de requerimientos tecnológicos y de mejora de procesos.
- Levantamiento y documentación de requerimientos complejos.
- Coordinación con equipos de desarrollo, QA y áreas de negocio.
- Validación funcional de soluciones mediante pruebas de aceptación o seguimiento a QA (solo si está explícito).
- Interlocución con usuarios y stakeholders para entendimiento y seguimiento de necesidades.
- Participación en la coordinación o guía de analistas de menor experiencia.
- Dominio funcional de los requerimientos del proyecto asignado.
- Identificación de problemáticas y propuesta de soluciones viables dentro del contexto del negocio.
- Uso de herramientas y metodologías de análisis (como UML o Design Thinking), solo si se mencionan explícitamente.
- Elaboración de documentación dentro de marcos de trabajo tradicionales y/o ágiles.
...
- Análisis de requerimientos tecnológicos o de mejora de procesos.
- Levantamiento o documentación de requerimientos complejos.
- Coordinación con desarrolladores, QA o áreas de negocio.
- Validación funcional de soluciones mediante pruebas de aceptación o seguimiento a QA.
- Interlocución con usuarios o stakeholders.
- Participación en la coordinación o guía de analistas junior.
- Identificación de problemáticas y propuesta de soluciones funcionales.
- Uso de herramientas o metodologías de análisis (ej. UML, Design Thinking), solo si está explícito.
- Elaboración de documentación funcional dentro de marcos de trabajo tradicionales o ágiles.
- Participación activa en el entendimiento integral de los requerimientos de un proyecto.

Si no hay evidencia explícita → OMITIR.

No reinterpretar:

- Toma de requerimientos básica sin análisis
- Actividades operativas de documentación sin participación en definición funcional
- Soporte a usuarios sin responsabilidad analítica
- Ejecución de pruebas sin participación en validación funcional
...
2. Buscar la experiencia más cercana a la actualidad cuyo puesto sea de nivel operativo analítico, tales como:
