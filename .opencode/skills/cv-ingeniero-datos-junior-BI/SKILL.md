---
name: cv-ingeniero-datos-junior-BI
...
Debe proyectar perfil junior con base técnica sólida y enfoque en aprendizaje y ejecución.
...
- Desarrollo o mantenimiento de procesos ETL/ELT.
- Manejo de bases de datos relacionales o no relacionales.
- Procesamiento o transformación de datos.
- Construcción o mantenimiento de estructuras de almacenamiento (Data Warehouse, Data Lake).
- Optimización de consultas o cargas.
- Participación en proyectos de datos o BI.
