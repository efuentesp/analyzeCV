---
name: cv-arquitecto-experto
description: Analiza CVs y devuelve únicamente un JSON estructurado para el rol de Arquiteccto Experto.
metadata:
  author: raquelizue
  version: "1.0.0"
---
...
"Cuento con al menos 3 años de experiencia en centro de desarrollo de software. Además, cuento con 5 años de experiencia en análisis de sistemas y manejo de equipos de trabajo."
...
"Valido que cada componente interactúe de forma sistémica en todas las iteraciones de un proyecto, para lograr congruencia con el flujo de negocio y de información (proceso funcional). Identifico dependencias y duplicidades. Propongo soluciones a las necesidades de manera integrada.
Habilidades en: Conocimiento de las plataformas de la Arquitectura de Referencia (AR), Resolución de problemas técnicos, Evaluación y optimización del rendimiento del sistema eligiendo las tecnologías más adecuadas."
